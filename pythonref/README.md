...
- If the signature was generated using MLDSA app:
    ```bash
    ./sign_cli.py verifyonchain --data "1234" --pubkey public_key.pem --signature sig --contractaddress 0x9B26cBD1643ba392a9a040529c0035693a4f6806 --rpc "wss://ethereum-sepolia-rpc.publicnode.com"
    ```
