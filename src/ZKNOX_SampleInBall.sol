...
// OPTIMIZATION: unchecked for bounded loops and arithmetic
function sampleInBallNist(bytes memory cTilde, uint256 tau, uint256 q) pure returns (uint256[] memory c) {
    ...
    // OPTIMIZATION: unchecked - loop is bounded [0..7], shift is bounded
    unchecked {
    ...
    // OPTIMIZATION: unchecked - i is bounded [256-tau..255], j <= i so bounded
    unchecked {
...
function sampleInBallKeccakPrng(bytes memory cTilde, uint256 tau, uint256 q) pure returns (uint256[] memory c) {
    ...
    // OPTIMIZATION: unchecked - loop is bounded [0..7]
    unchecked {
