...
contract PythonSigner is Test {
    ...
    function sign(string memory data, string memory mode, string memory seedStr) external returns (bytes memory cTilde, bytes memory z, bytes memory h, uint8 v, uint256 r, uint256 s) {
