...
contract ZKNOX_dilithium {
    ...
    function compute_c_ntt(Signature memory signature) public view returns (uint256[] memory c) {
    ...
    function COMPUTE_C_NTT(bytes memory c_tilde) public view returns (uint256[] memory c) {
        ctx_shake memory ctx;
