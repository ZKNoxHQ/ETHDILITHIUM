...
# Constants
# SIMON CHANGED 1024 to 3072, IS IT SECURE?????????????????
MAX_BUFFER_SIZE = 3072  # Adjust based on needs
...
class Keccak256PRNG:
    ...
    # Two function to match `shake/shake_wrapper.py` syntax.
    # We could rename absorb everywhere instead.
