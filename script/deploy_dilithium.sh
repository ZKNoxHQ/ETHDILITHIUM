...
# Configuration
CONTRACT_NAME="DeployDilithium.s.sol"   
...
forge script $CONTRACT_NAME --rpc-url $RPC --private-key $PRIVATE_KEY --broadcast --tc Script_Deploy_Dilithium --etherscan-api-key $API_KEY --verify --priority-gas-price 1
