...
# Configuration
CONTRACT_NAME="DeployP256VERIFY.s.sol"   
...
forge script $CONTRACT_NAME --rpc-url $RPC --private-key $PRIVATE_KEY --broadcast --tc Script_Deploy_P256VERIFY --etherscan-api-key $API_KEY --verify --priority-gas-price 1
